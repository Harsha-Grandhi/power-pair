  ...
  return (
    <div className="px-5 pb-6 space-y-3 pt-3">
      ...
      <NavBanner
        ...
        borderColor="border-cyan-800/25"
        gradientFrom="from-cyan-800/8"
        gradientTo="to-teal-800/6"
      >
        <div className="flex items-center justify-between mt-0.5">
          <p className="text-sm text-white/85 font-medium leading-tight truncate">
            All the evidence you need to love them right
          </p>
          <span className="text-base font-bold font-display ml-2 flex-shrink-0 text-cyan-700">
