        ...
        <section className="flex-1 flex flex-col justify-center py-12">
          <div className="space-y-2 mb-8">
            ...
            <p className="text-sm text-pp-text-muted">
              Sign up to take the quiz and discover your relationship archetype.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs text-pp-text-muted mb-1.5">Confirm Password</label>
              <input
                id="confirmPassword"
                type="password"
                required
            ...
            <button
              ...
              className="w-full py-3.5 rounded-xl bg-pp-accent text-pp-bg-dark font-semibold text-sm
                ...
                disabled:opacity-50"
            >
              {loading ? 'Creating account...' : 'Sign Up & Begin Quiz'}
            </button>
          </form>
